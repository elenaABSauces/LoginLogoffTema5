<?php
   ...
   session_start();
    ...
    if (!isset($_SESSION['usuarioDAW216LoginLogoffTema5'])) {//Si el usuario no se ha autentificado
    ...
    if($entradaOK){ // Si el usuario ha rellenado el formulario correctamente rellenamos el array aFormulario con las respuestas introducidas por el usuario
        try{//validamos que la CodUsuario sea correcta
            ...
            $parametros = [":Password" => hash("sha256", ($_SESSION['usuarioDAW216LoginLogoffTema5'].$_REQUEST['PasswordNueva'])),
                           ":CodUsuario" => $_SESSION['usuarioDAW216LoginLogoffTema5']];
...
<body>
    ...
    <footer> 
        <table class="tablaFooter">
            <tr> 
                <td><address> <a href="../../index.html">Elena de AntOn &copy; 2020/21</a> <a href="https://github.com/elenaABSauces/proyectoMtoDepartamentosTema4" target="_blank"><img src="webroot/media/github.png" widht="20" height="20" /></a></address></td>
            </tr>
        </table>
    </footer>
</body>
